...
image.get("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            return [4 /*yield*/, (0, sharp_1.default)(path_1.default.join(process.cwd(), "assets/".concat(imgQuery.name, ".jpg")))
                    .resize(parseInt(imgQuery.width), parseInt(imgQuery.height))
                    .toFile("assets/thumbs/".concat(imgQuery.name, "_").concat(imgQuery.width, "_").concat(imgQuery.height, ".png"))];
            case 2:
                /* fs.appendFile(
                  path.join(process.cwd(), "assets/paths.json"),
                  `${imgQuery.name}_${imgQuery.width}_${imgQuery.height}.png`
                ...
                _a.sent();
                res.sendFile(path_1.default.join(process.cwd(), "assets/thumbs/".concat(imgQuery.name, "_").concat(imgQuery.width, "_").concat(imgQuery.height, ".png")));
                _a.label = 3;
